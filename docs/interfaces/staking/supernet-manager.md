The `SupernetManager` contract is an abstract contract for managing Furtheon-powered chains. It serves as a base contract that should be implemented with custom desired functionality.
