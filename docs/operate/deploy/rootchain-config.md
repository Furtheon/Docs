...
| `--data-dir`                 | The directory for the Furtheon data if the local FS is used.              | `--data-dir test-chain-`                     |
...
| `--data-dir`    | Directory for the Furtheon data if the local FS is used                                            |         |
