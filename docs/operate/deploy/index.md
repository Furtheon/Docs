This serves as an index for the Furtheon deployment guides. 
The guides explain the end-to-end process for setting up and deploying a local Furtheon-powered chain.
...
In this tutorial, you will learn how to set up and initialize an Furtheon-powered chain with multiple nodes. You will learn the complete end-to-end genesis workflow of building an Furtheon-powered chain, including:
...
- Running an (Furtheon) cluster consisting of multiple PolyBFT nodes.

By the end of this tutorial, you will have a fully functional Furtheon test network that can be used to process transactions with high throughput and low latency.

## What you'll do

The deployment guides will cover the steps outlined below. If you are deploying an Furtheon-powered chain for the first time, please navigate each section in order. 

1. [<ins>Spawn a New Furtheon-powered chain</ins>](local-chain.md)
2. [<ins>Configure Your New Furtheon-powered chain</ins>](genesis.md)
3. [<ins>Configure the Rootchain</ins>](rootchain-config.md)
4. [<ins>Configure the Initial Validator Set</ins>](genesis-validators.md)
5. [<ins>Start Your New Furtheon-powered chain</ins>](start-chain.md)

<details>
<summary>Fast-track guide ↓</summary>

**Here's the fast-track guide if you're looking for a quick guide on the essential commands needed to set up a local Furtheon-powered chain.**
