In this section, we'll prepare initiate a new chain with PolyBFT consensus and prepare the initial Furtheon nodes.
...
| `--data-dir`    | The directory for the Furtheon data if the local FS is used.                                          | `--data-dir /path/to/dir`  |
