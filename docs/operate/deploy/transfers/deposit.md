...
This command deposits ERC-20 tokens from a rootchain to a Furtheon-powered chain. 
...
In this example, we're depositing ERC-20 tokens to a test Furtheon instance:
...
This command deposits ERC-721 tokens from a rootchain to a Furtheon-powered chain.
...
In this example, we're depositing ERC-721 tokens to a test Furtheon instance:
...
This command deposits ERC-1155 tokens from the rootchain to the Furtheon-powered chain.
...
In this example, we're depositing ERC-1155 tokens to a test Furtheon instance:
